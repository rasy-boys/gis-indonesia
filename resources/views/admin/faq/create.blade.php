            ...
            <div class="card-body">
                <form action="{{ route('admin.faq.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div id="editor-answer" style="height: 150px;">{!! old('answer') !!}</div>
...
@push('scripts')
    ...
    <script>
        // Inisialisasi Quill untuk jawaban
        var quillAnswer = new Quill('#editor-answer', {
            theme: 'snow'
        });

        // Set isi awal dari old('answer') jika ada
        quillAnswer.root.innerHTML = `{!! old('answer') !!}`;

        // Fungsi sync isi Quill ke hidden input
        ...
        document.querySelector('form').addEventListener('submit', function (e) {
            ...
            // Jika kosong (hanya tag <p><br></p>), batalkan submit
            if (document.getElementById('answer').value.replace(/<(.|\n)*?>/g, '').trim() === '') {
                e.preventDefault();
