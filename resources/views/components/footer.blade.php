                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-wrapper pr--15">
                            ...
                            <div class="single-post">
                                ...
                                <div class="content">
                                    <div class="date"><i class="fa-light fa-calendar-days"></i><span>{{ \Carbon\Carbon::parse($recent->tanggal)->translatedFormat('d M Y') }}</span></div>

                                    <a href="/">
                                        <h6 class="title">{{ Str::limit($recent->judul, 50) }}</h6>
                                    </a>
                                </div>
                            </div>
                              </a>
